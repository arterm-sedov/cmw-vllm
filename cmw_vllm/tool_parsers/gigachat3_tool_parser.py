...
"""
GigaChat3 Tool Parser Plugin

Based on vLLM source: https://github.com/vllm-project/vllm/blob/main/vllm/tool_parsers/gigachat3_tool_parser.py
See: https://docs.vllm.ai/en/latest/features/tool_calling/#how-to-write-a-tool-parser-plugin
"""
...
class GigaChat3ToolParser(ToolParser):
    """Tool parser for GigaChat3 models.
    
    Parses tool calls in format: function call{...} or function call<|role_sep|>\n{...}
    """
